...
public class TestBook {
    public static void main(String[] args) {
        ...
        Book book3 = new Book("Anna Karenina", "Leo Tolstoi", 1878, 864, Genre.CLASSIC, Cover.HARD, "russian");//"Petrov", "02.10.2020", "30.10.2020");
        Book book4 = new Book("The Master and Margarita", "Mikhail Bulgakov", 1966, 480, Genre.DRAMA, Cover.HARD, "russian");//"Katz", "02.10.2020", "30.10.2020");
